...
\setbeamertemplate{headline}{}		% Remove Naviagtion
...
\include{tex/03_our-copter/can}
\include{tex/03_our-copter/can_not}
\include{tex/03_our-copter/limits}


% ******** USAGE ********
\include{tex/04_usage/toc}
\include{tex/04_usage/personal}
\include{tex/04_usage/professional}


% ******** CONCULSION ********
\include{tex/05_outlook/toc}
%\include{tex/05_outlook/sources}
